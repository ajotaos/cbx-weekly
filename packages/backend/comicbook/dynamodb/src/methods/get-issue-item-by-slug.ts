...
export async function getIssueItemBySlugFromTable(
	props: GetIssueItemBySlugFromTable.Props,
	tableName: string,
	...
	if (item === undefined) {
		throwItemNotFoundError('issue', { slug });
	}
...
export declare namespace GetIssueItemBySlugFromTable {
